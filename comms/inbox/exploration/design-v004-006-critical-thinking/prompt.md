You are performing Task 006: Critical Thinking and Risk Investigation for stoat-and-ferret version v004.
...
This is Phase 2 (Logical Design and Critical Thinking) for stoat-and-ferret version v004. Task 005 produced a logical design with a "Risks and Unknowns" section. This task investigates each risk, resolves unknowns where possible, and produces an updated design that incorporates findings.
...
- `comms/outbox/versions/design/v004/005-logical-design/risks-and-unknowns.md`
...
- ALL backlog items from PLAN.md still covered (mandatory scope — no deferrals)
...
Create findings in comms/outbox/exploration/design-v004-006-critical-thinking/:
...
For each risk from Task 005: original severity, category, investigation, finding, resolution, affected themes/features.

### refined-logical-design.md

Updated logical design incorporating all findings. Same structure as Task 005's logical-design.md but with risk resolutions integrated, updated structures, and references to risk-assessment.md.
...
After writing all output files to comms/outbox/exploration/design-v004-006-critical-thinking/, also COPY all files to comms/outbox/versions/design/v004/006-critical-thinking/ so they are in the design artifact store.

git add comms/outbox/exploration/design-v004-006-critical-thinking/
git commit -m "exploration: design-v004-006-critical-thinking - critical thinking complete"
