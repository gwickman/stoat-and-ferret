...
|---------|------|------|-------|
| v005 | full | [date] | [any notes about gaps or issues] |
...
Save outputs to `comms/outbox/exploration/c4-v005-006-finalize/`:
...
Then:
- **Files Present:** complete inventory with checkmark/cross status
