...
This is Phase 4 (Validation) for stoat-and-ferret version v004.
...
- Read comms/outbox/exploration/design-v004-007-drafts/drafts/manifest.json
- Read individual draft files under comms/outbox/exploration/design-v004-007-drafts/drafts/
...
Run validate_version_design(project="stoat-and-ferret", version="v004"):
...
The backlog items for v004 are: BL-020, BL-021, BL-022, BL-023, BL-024, BL-025, BL-026, BL-027, BL-009, BL-010, BL-012, BL-014, BL-016.

For each feature:
- Verify it references correct BL-XXX items
- Check acceptance criteria match backlog (from comms/outbox/versions/design/v004/002-backlog/backlog-details.md)
- Document any mismatches

Across all features:
- Verify EVERY backlog item from the list above is mapped to at least one feature
...
- Check git status for uncommitted changes in comms/inbox/versions/execution/v004/
...
Create in comms/outbox/exploration/design-v004-009-validation/:
...
Full 13-item checklist with PASS/FAIL status and detailed notes for each.
...
```bash
git add comms/outbox/exploration/design-v004-009-validation/
git commit -m "exploration: design-v004-009-validation complete - [PASS/FAIL]"
```
