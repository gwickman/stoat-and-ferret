...
```bash
git checkout -b v011/01-scan-and-clip-ux/001-browse-directory
```
...
**Feature:** 001-browse-directory

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v011/01-scan-and-clip-ux/001-browse-directory/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v011/01-scan-and-clip-ux/001-browse-directory/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v011/01-scan-and-clip-ux/001-browse-directory/`:
