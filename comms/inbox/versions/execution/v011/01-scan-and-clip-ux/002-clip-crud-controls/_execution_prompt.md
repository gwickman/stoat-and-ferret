...
```bash
git checkout -b v011/01-scan-and-clip-ux/002-clip-crud-controls
```
...
**Feature:** 002-clip-crud-controls

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v011/01-scan-and-clip-ux/002-clip-crud-controls/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v011/01-scan-and-clip-ux/002-clip-crud-controls/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v011/01-scan-and-clip-ux/002-clip-crud-controls/`:
