...
```bash
git checkout -b v011/02-developer-onboarding/001-env-example
```
...
**Feature:** 001-env-example

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v011/02-developer-onboarding/001-env-example/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v011/02-developer-onboarding/001-env-example/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v011/02-developer-onboarding/001-env-example/`:
