...
```bash
git checkout -b v011/02-developer-onboarding/002-windows-dev-guidance
```
...
**Feature:** 002-windows-dev-guidance

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v011/02-developer-onboarding/002-windows-dev-guidance/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v011/02-developer-onboarding/002-windows-dev-guidance/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v011/02-developer-onboarding/002-windows-dev-guidance/`:
