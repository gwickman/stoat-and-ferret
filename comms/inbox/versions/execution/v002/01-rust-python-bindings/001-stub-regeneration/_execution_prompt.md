...
```bash
git checkout -b v002/01-rust-python-bindings/001-stub-regeneration
```
...
**Feature:** 001-stub-regeneration

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v002/01-rust-python-bindings/001-stub-regeneration/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v002/01-rust-python-bindings/001-stub-regeneration/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v002/01-rust-python-bindings/001-stub-regeneration/`:
