...
```bash
git checkout -b v001/02-timeline-math/001-position-calculations
```
...
**Feature:** 001-position-calculations

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/02-timeline-math/001-position-calculations/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/02-timeline-math/001-position-calculations/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/02-timeline-math/001-position-calculations/`:
