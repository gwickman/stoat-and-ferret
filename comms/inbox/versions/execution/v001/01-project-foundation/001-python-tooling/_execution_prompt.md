...
```bash
git checkout -b v001/01-project-foundation/001-python-tooling
```
...
**Feature:** 001-python-tooling

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/01-project-foundation/001-python-tooling/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/01-project-foundation/001-python-tooling/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/01-project-foundation/001-python-tooling/`:
