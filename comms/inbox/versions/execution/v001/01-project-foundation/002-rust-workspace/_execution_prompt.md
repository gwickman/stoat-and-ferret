...
```bash
git checkout -b v001/01-project-foundation/002-rust-workspace
```
...
**Feature:** 002-rust-workspace

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/01-project-foundation/002-rust-workspace/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/01-project-foundation/002-rust-workspace/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/01-project-foundation/002-rust-workspace/`:
