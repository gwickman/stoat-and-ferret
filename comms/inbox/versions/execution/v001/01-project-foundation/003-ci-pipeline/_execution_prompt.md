...
```bash
git checkout -b v001/01-project-foundation/003-ci-pipeline
```
...
1. **Requirements:** `comms/inbox/versions/execution/v001/01-project-foundation/003-ci-pipeline/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/01-project-foundation/003-ci-pipeline/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/01-project-foundation/003-ci-pipeline/`:
