...
```bash
git checkout -b v001/03-command-builder/003-input-sanitization
```
...
**Feature:** 003-input-sanitization

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/03-command-builder/003-input-sanitization/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/03-command-builder/003-input-sanitization/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/03-command-builder/003-input-sanitization/`:
