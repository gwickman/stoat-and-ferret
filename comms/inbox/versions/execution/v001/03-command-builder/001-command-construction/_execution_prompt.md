...
```bash
git checkout -b v001/03-command-builder/001-command-construction
```
...
**Feature:** 001-command-construction

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/03-command-builder/001-command-construction/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/03-command-builder/001-command-construction/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/03-command-builder/001-command-construction/`:
