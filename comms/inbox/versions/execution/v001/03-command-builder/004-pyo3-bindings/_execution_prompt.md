...
```bash
git checkout -b v001/03-command-builder/004-pyo3-bindings
```
...
**Feature:** 004-pyo3-bindings

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v001/03-command-builder/004-pyo3-bindings/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v001/03-command-builder/004-pyo3-bindings/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v001/03-command-builder/004-pyo3-bindings/`:
