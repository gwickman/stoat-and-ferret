...
```bash
git checkout -b v003/04-clip-model/003-clip-repository
```
...
**Version:** v003
**Theme:** 04-clip-model
**Feature:** 003-clip-repository

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/04-clip-model/003-clip-repository/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/04-clip-model/003-clip-repository/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/04-clip-model/003-clip-repository/`:
