...
1. Read `comms/inbox/versions/execution/v003/THEME_INDEX.md` for the execution order
...
Update `comms/outbox/versions/execution/v003/STATUS.md` after each feature:
