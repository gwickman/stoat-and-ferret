...
```bash
git checkout -b v003/03-library-api/001-videos-list-detail
```
...
**Feature:** 001-videos-list-detail

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/03-library-api/001-videos-list-detail/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/03-library-api/001-videos-list-detail/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/03-library-api/001-videos-list-detail/`:
