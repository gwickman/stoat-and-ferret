...
```bash
git checkout -b v003/03-library-api/003-videos-scan
```
...
**Feature:** 003-videos-scan

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/03-library-api/003-videos-scan/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/03-library-api/003-videos-scan/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/03-library-api/003-videos-scan/`:
