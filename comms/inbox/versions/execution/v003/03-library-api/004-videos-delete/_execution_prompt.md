...
```bash
git checkout -b v003/03-library-api/004-videos-delete
```
...
**Feature:** 004-videos-delete

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/03-library-api/004-videos-delete/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/03-library-api/004-videos-delete/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/03-library-api/004-videos-delete/`:
