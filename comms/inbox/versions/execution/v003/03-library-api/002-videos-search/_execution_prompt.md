...
```bash
git checkout -b v003/03-library-api/002-videos-search
```
...
**Feature:** 002-videos-search

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v003/03-library-api/002-videos-search/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v003/03-library-api/002-videos-search/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v003/03-library-api/002-videos-search/`:
