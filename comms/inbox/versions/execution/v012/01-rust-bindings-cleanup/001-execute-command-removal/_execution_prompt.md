...
```bash
git checkout -b v012/01-rust-bindings-cleanup/001-execute-command-removal
```
...
1. **Requirements:** `comms/inbox/versions/execution/v012/01-rust-bindings-cleanup/001-execute-command-removal/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v012/01-rust-bindings-cleanup/001-execute-command-removal/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v012/01-rust-bindings-cleanup/001-execute-command-removal/`:
