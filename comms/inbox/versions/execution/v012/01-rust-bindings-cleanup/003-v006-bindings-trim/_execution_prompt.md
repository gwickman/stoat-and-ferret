...
```bash
git checkout -b v012/01-rust-bindings-cleanup/003-v006-bindings-trim
```
...
1. **Requirements:** `comms/inbox/versions/execution/v012/01-rust-bindings-cleanup/003-v006-bindings-trim/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v012/01-rust-bindings-cleanup/003-v006-bindings-trim/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v012/01-rust-bindings-cleanup/003-v006-bindings-trim/`:
