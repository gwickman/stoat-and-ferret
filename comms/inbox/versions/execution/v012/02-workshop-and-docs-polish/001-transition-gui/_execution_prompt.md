...
```bash
git checkout -b v012/02-workshop-and-docs-polish/001-transition-gui
```
...
1. **Requirements:** `comms/inbox/versions/execution/v012/02-workshop-and-docs-polish/001-transition-gui/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v012/02-workshop-and-docs-polish/001-transition-gui/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v012/02-workshop-and-docs-polish/001-transition-gui/`:
