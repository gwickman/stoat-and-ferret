...
```bash
git checkout -b v012/02-workshop-and-docs-polish/002-api-spec-corrections
```
...
1. **Requirements:** `comms/inbox/versions/execution/v012/02-workshop-and-docs-polish/002-api-spec-corrections/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v012/02-workshop-and-docs-polish/002-api-spec-corrections/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v012/02-workshop-and-docs-polish/002-api-spec-corrections/`:
...
You have file-level tools only (Read, Write, Edit, Bash) plus read-only MCP tools (get_project_info, read_document). State-modifying MCP tools are not available. Do not edit state files (backlog.json, learnings.json, etc.) directly.