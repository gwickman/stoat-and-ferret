...
```bash
git checkout -b v004/03-async-scan/001-job-queue-infrastructure
```
...
**Version:** v004
**Theme:** 03-async-scan
**Feature:** 001-job-queue-infrastructure

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/03-async-scan/001-job-queue-infrastructure/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/03-async-scan/001-job-queue-infrastructure/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/03-async-scan/001-job-queue-infrastructure/`:
