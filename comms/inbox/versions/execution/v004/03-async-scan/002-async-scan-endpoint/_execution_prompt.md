...
```bash
git checkout -b v004/03-async-scan/002-async-scan-endpoint
```
...
**Version:** v004
**Theme:** 03-async-scan
**Feature:** 002-async-scan-endpoint

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/03-async-scan/002-async-scan-endpoint/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/03-async-scan/002-async-scan-endpoint/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/03-async-scan/002-async-scan-endpoint/`:
