...
```bash
git checkout -b v004/03-async-scan/003-scan-doc-updates
```
...
**Version:** v004
**Theme:** 03-async-scan
**Feature:** 003-scan-doc-updates

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/03-async-scan/003-scan-doc-updates/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/03-async-scan/003-scan-doc-updates/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/03-async-scan/003-scan-doc-updates/`:
