...
```bash
git checkout -b v004/04-security-performance/001-security-audit
```
...
**Feature:** 001-security-audit

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/04-security-performance/001-security-audit/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/04-security-performance/001-security-audit/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/04-security-performance/001-security-audit/`:
