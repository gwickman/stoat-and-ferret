...
```bash
git checkout -b v004/05-devex-coverage/001-property-test-guidance
```
...
**Feature:** 001-property-test-guidance

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/05-devex-coverage/001-property-test-guidance/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/05-devex-coverage/001-property-test-guidance/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/05-devex-coverage/001-property-test-guidance/`:
