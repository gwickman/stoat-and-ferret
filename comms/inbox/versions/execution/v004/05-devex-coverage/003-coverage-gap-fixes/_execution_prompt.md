...
```bash
git checkout -b v004/05-devex-coverage/003-coverage-gap-fixes
```
...
**Feature:** 003-coverage-gap-fixes

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/05-devex-coverage/003-coverage-gap-fixes/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/05-devex-coverage/003-coverage-gap-fixes/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/05-devex-coverage/003-coverage-gap-fixes/`:
