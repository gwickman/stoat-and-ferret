...
```bash
git checkout -b v004/05-devex-coverage/002-rust-coverage
```
...
**Feature:** 002-rust-coverage

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/05-devex-coverage/002-rust-coverage/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/05-devex-coverage/002-rust-coverage/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/05-devex-coverage/002-rust-coverage/`:
