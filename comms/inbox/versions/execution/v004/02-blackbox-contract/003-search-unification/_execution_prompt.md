...
```bash
git checkout -b v004/02-blackbox-contract/003-search-unification
```
...
**Feature:** 003-search-unification

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/02-blackbox-contract/003-search-unification/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/02-blackbox-contract/003-search-unification/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/02-blackbox-contract/003-search-unification/`:
