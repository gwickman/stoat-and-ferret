...
```bash
git checkout -b v004/02-blackbox-contract/001-blackbox-test-catalog
```
...
**Feature:** 001-blackbox-test-catalog

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/02-blackbox-contract/001-blackbox-test-catalog/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/02-blackbox-contract/001-blackbox-test-catalog/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/02-blackbox-contract/001-blackbox-test-catalog/`:
