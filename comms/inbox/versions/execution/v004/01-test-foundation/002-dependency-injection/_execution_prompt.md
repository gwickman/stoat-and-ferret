...
```bash
git checkout -b v004/01-test-foundation/002-dependency-injection
```
...
**Feature:** 002-dependency-injection

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v004/01-test-foundation/002-dependency-injection/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v004/01-test-foundation/002-dependency-injection/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v004/01-test-foundation/002-dependency-injection/`:
