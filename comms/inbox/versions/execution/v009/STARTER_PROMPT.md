...
1. Read `comms/inbox/versions/execution/v009/THEME_INDEX.md` for the execution order
...
Update `comms/outbox/versions/execution/v009/STATUS.md` after each feature:
