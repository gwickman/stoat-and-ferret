...
```bash
git checkout -b v009/02-gui-runtime-fixes/003-websocket-broadcasts
```
...
**Feature:** 003-websocket-broadcasts

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v009/02-gui-runtime-fixes/003-websocket-broadcasts/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v009/02-gui-runtime-fixes/003-websocket-broadcasts/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v009/02-gui-runtime-fixes/003-websocket-broadcasts/`:
