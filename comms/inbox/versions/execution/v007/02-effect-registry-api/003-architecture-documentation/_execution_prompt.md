...
```bash
git checkout -b v007/02-effect-registry-api/003-architecture-documentation
```
...
**Feature:** 003-architecture-documentation

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v007/02-effect-registry-api/003-architecture-documentation/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v007/02-effect-registry-api/003-architecture-documentation/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v007/02-effect-registry-api/003-architecture-documentation/`:
