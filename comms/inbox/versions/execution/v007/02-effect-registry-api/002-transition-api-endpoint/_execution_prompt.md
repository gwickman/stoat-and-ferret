...
```bash
git checkout -b v007/02-effect-registry-api/002-transition-api-endpoint
```
...
**Feature:** 002-transition-api-endpoint

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v007/02-effect-registry-api/002-transition-api-endpoint/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v007/02-effect-registry-api/002-transition-api-endpoint/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v007/02-effect-registry-api/002-transition-api-endpoint/`:
