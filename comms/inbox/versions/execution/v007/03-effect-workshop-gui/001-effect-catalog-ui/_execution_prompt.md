...
```bash
git checkout -b v007/03-effect-workshop-gui/001-effect-catalog-ui
```
...
**Feature:** 001-effect-catalog-ui

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v007/03-effect-workshop-gui/001-effect-catalog-ui/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v007/03-effect-workshop-gui/001-effect-catalog-ui/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v007/03-effect-workshop-gui/001-effect-catalog-ui/`:
