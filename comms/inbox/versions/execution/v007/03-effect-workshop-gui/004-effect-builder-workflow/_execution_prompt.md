...
```bash
git checkout -b v007/03-effect-workshop-gui/004-effect-builder-workflow
```
...
**Feature:** 004-effect-builder-workflow

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v007/03-effect-workshop-gui/004-effect-builder-workflow/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v007/03-effect-workshop-gui/004-effect-builder-workflow/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v007/03-effect-workshop-gui/004-effect-builder-workflow/`:
