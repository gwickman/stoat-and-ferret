...
```bash
git checkout -b v007/01-rust-filter-builders/002-transition-filter-builders
```
...
**Feature:** 002-transition-filter-builders

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v007/01-rust-filter-builders/002-transition-filter-builders/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v007/01-rust-filter-builders/002-transition-filter-builders/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v007/01-rust-filter-builders/002-transition-filter-builders/`:
