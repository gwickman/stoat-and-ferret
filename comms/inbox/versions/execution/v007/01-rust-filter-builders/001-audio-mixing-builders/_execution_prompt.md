...
```bash
git checkout -b v007/01-rust-filter-builders/001-audio-mixing-builders
```
...
**Feature:** 001-audio-mixing-builders

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v007/01-rust-filter-builders/001-audio-mixing-builders/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v007/01-rust-filter-builders/001-audio-mixing-builders/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v007/01-rust-filter-builders/001-audio-mixing-builders/`:
