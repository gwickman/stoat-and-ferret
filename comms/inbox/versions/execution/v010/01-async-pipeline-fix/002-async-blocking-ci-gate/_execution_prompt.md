...
```bash
git checkout -b v010/01-async-pipeline-fix/002-async-blocking-ci-gate
```
...
1. **Requirements:** `comms/inbox/versions/execution/v010/01-async-pipeline-fix/002-async-blocking-ci-gate/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v010/01-async-pipeline-fix/002-async-blocking-ci-gate/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v010/01-async-pipeline-fix/002-async-blocking-ci-gate/`:
