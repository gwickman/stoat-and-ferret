...
```bash
git checkout -b v010/01-async-pipeline-fix/001-fix-blocking-ffprobe
```
...
1. **Requirements:** `comms/inbox/versions/execution/v010/01-async-pipeline-fix/001-fix-blocking-ffprobe/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v010/01-async-pipeline-fix/001-fix-blocking-ffprobe/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v010/01-async-pipeline-fix/001-fix-blocking-ffprobe/`:
