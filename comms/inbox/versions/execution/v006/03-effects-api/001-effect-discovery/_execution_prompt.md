...
```bash
git checkout -b v006/03-effects-api/001-effect-discovery
```
...
1. **Requirements:** `comms/inbox/versions/execution/v006/03-effects-api/001-effect-discovery/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v006/03-effects-api/001-effect-discovery/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v006/03-effects-api/001-effect-discovery/`:
