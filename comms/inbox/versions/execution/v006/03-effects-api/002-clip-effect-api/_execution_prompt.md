...
```bash
git checkout -b v006/03-effects-api/002-clip-effect-api
```
...
**Feature:** 002-clip-effect-api

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v006/03-effects-api/002-clip-effect-api/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v006/03-effects-api/002-clip-effect-api/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v006/03-effects-api/002-clip-effect-api/`:
