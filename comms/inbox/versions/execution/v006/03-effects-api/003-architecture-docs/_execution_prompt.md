...
```bash
git checkout -b v006/03-effects-api/003-architecture-docs
```
...
**Feature:** 003-architecture-docs

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v006/03-effects-api/003-architecture-docs/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v006/03-effects-api/003-architecture-docs/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v006/03-effects-api/003-architecture-docs/`:
