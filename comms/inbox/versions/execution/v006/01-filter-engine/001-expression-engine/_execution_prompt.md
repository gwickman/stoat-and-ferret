...
```bash
git checkout -b v006/01-filter-engine/001-expression-engine
```
...
**Feature:** 001-expression-engine

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v006/01-filter-engine/001-expression-engine/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v006/01-filter-engine/001-expression-engine/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v006/01-filter-engine/001-expression-engine/`:
