...
```bash
git checkout -b v006/02-filter-builders/001-drawtext-builder
```
...
**Feature:** 001-drawtext-builder

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v006/02-filter-builders/001-drawtext-builder/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v006/02-filter-builders/001-drawtext-builder/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v006/02-filter-builders/001-drawtext-builder/`:
