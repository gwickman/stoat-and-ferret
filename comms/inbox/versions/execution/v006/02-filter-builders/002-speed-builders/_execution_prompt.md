...
```bash
git checkout -b v006/02-filter-builders/002-speed-builders
```
...
**Feature:** 002-speed-builders

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v006/02-filter-builders/002-speed-builders/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v006/02-filter-builders/002-speed-builders/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v006/02-filter-builders/002-speed-builders/`:
