...
1. Read `comms/inbox/versions/execution/v006/THEME_INDEX.md` for the execution order
...
Update `comms/outbox/versions/execution/v006/STATUS.md` after each feature:
