...
```bash
git checkout -b v005/04-e2e-testing/002-e2e-test-suite
```
...
1. **Requirements:** `comms/inbox/versions/execution/v005/04-e2e-testing/002-e2e-test-suite/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/04-e2e-testing/002-e2e-test-suite/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/04-e2e-testing/002-e2e-test-suite/`:
