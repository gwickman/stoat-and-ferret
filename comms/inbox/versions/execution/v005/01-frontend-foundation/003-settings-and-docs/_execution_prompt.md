...
```bash
git checkout -b v005/01-frontend-foundation/003-settings-and-docs
```
...
**Feature:** 003-settings-and-docs

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v005/01-frontend-foundation/003-settings-and-docs/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/01-frontend-foundation/003-settings-and-docs/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/01-frontend-foundation/003-settings-and-docs/`:
