...
```bash
git checkout -b v005/01-frontend-foundation/001-frontend-scaffolding
```
...
**Feature:** 001-frontend-scaffolding

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v005/01-frontend-foundation/001-frontend-scaffolding/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/01-frontend-foundation/001-frontend-scaffolding/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/01-frontend-foundation/001-frontend-scaffolding/`:
