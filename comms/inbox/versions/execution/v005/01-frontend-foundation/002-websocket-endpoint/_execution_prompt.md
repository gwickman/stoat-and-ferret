...
```bash
git checkout -b v005/01-frontend-foundation/002-websocket-endpoint
```
...
**Feature:** 002-websocket-endpoint

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v005/01-frontend-foundation/002-websocket-endpoint/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/01-frontend-foundation/002-websocket-endpoint/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/01-frontend-foundation/002-websocket-endpoint/`:
