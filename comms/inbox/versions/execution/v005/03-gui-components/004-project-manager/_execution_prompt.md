...
```bash
git checkout -b v005/03-gui-components/004-project-manager
```
...
**Feature:** 004-project-manager

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v005/03-gui-components/004-project-manager/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/03-gui-components/004-project-manager/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/03-gui-components/004-project-manager/`:
