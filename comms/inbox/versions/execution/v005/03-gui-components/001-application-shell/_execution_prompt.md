...
```bash
git checkout -b v005/03-gui-components/001-application-shell
```
...
**Feature:** 001-application-shell

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v005/03-gui-components/001-application-shell/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/03-gui-components/001-application-shell/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/03-gui-components/001-application-shell/`:
