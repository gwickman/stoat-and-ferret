...
```bash
git checkout -b v005/03-gui-components/002-dashboard-panel
```
...
**Feature:** 002-dashboard-panel

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v005/03-gui-components/002-dashboard-panel/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/03-gui-components/002-dashboard-panel/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/03-gui-components/002-dashboard-panel/`:
