...
```bash
git checkout -b v005/03-gui-components/003-library-browser
```
...
**Feature:** 003-library-browser

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v005/03-gui-components/003-library-browser/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/03-gui-components/003-library-browser/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/03-gui-components/003-library-browser/`:
