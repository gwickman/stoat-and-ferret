...
```bash
git checkout -b v005/02-backend-services/002-pagination-total-count
```
...
**Feature:** 002-pagination-total-count

## Input Documents

Use the Read tool to read these files before starting:

1. **Requirements:** `comms/inbox/versions/execution/v005/02-backend-services/002-pagination-total-count/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v005/02-backend-services/002-pagination-total-count/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v005/02-backend-services/002-pagination-total-count/`:
