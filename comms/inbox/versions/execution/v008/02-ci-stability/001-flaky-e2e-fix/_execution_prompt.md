...
```bash
git checkout -b v008/02-ci-stability/001-flaky-e2e-fix
```
...
1. **Requirements:** `comms/inbox/versions/execution/v008/02-ci-stability/001-flaky-e2e-fix/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v008/02-ci-stability/001-flaky-e2e-fix/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v008/02-ci-stability/001-flaky-e2e-fix/`:
