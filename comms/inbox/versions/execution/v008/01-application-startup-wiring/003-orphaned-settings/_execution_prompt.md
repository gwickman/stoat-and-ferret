...
```bash
git checkout -b v008/01-application-startup-wiring/003-orphaned-settings
```
...
1. **Requirements:** `comms/inbox/versions/execution/v008/01-application-startup-wiring/003-orphaned-settings/requirements.md`
2. **Implementation Plan:** `comms/inbox/versions/execution/v008/01-application-startup-wiring/003-orphaned-settings/implementation-plan.md`
...
Use Write tool to create these in `comms/outbox/versions/execution/v008/01-application-startup-wiring/003-orphaned-settings/`:
