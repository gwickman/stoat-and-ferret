...
**Theme Path:** comms/outbox/versions/execution/v008/02-ci-stability

## Input Documents

Review these before writing the retrospective:

1. **Theme Definition:** `comms/outbox/versions/execution/v008/02-ci-stability/theme.md`
2. **Progress:** `comms/outbox/versions/execution/v008/02-ci-stability/progress.md` or `progress.json`
3. **Feature Completion Reports:** `comms/outbox/versions/execution/v008/02-ci-stability/*/completion-report.md`
4. **Feature Quality Gaps:** `comms/outbox/versions/execution/v008/02-ci-stability/*/quality-gaps.md`
...
Create `comms/outbox/versions/execution/v008/02-ci-stability/retrospective.md` with:
...
Single file: `comms/outbox/versions/execution/v008/02-ci-stability/retrospective.md`
