...
**Version:** {v001}
**Version Path:** `comms/outbox/versions/execution/{v001}/`

## Input Documents

Review these before writing the retrospective:

1. **Version Definition:** `comms/inbox/versions/execution/{v001}/THEME_INDEX.md`
2. **Theme Retrospectives:** All `*/retrospective.md` files
3. **Status File:** `comms/outbox/versions/execution/{v001}/STATUS.md`
...
Create `comms/outbox/versions/execution/{v001}/retrospective.md` with:
...
1. `comms/outbox/versions/execution/{v001}/retrospective.md`
