...
**Version:** {v003}
**Version Path:** `comms/outbox/versions/execution/{v003}/`

## Input Documents

Review these before writing the retrospective:

1. **Version Definition:** `comms/inbox/versions/execution/{v003}/THEME_INDEX.md`
2. **Theme Retrospectives:** All `*/retrospective.md` files
3. **Status File:** `comms/outbox/versions/execution/{v003}/STATUS.md`
...
Create `comms/outbox/versions/execution/{v003}/retrospective.md` with:
...
1. `comms/outbox/versions/execution/{v003}/retrospective.md`
