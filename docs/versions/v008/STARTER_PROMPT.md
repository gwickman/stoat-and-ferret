...
1. Read `comms/inbox/versions/execution/v008/THEME_INDEX.md` for the execution order
...
Update `comms/outbox/versions/execution/v008/STATUS.md` after each feature:
