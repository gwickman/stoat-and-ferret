...
1. Read `comms/inbox/versions/execution/v005/THEME_INDEX.md` for the execution order
...
Update `comms/outbox/versions/execution/v005/STATUS.md` after each feature:
