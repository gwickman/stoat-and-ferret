...
1. Read `comms/inbox/versions/execution/v012/THEME_INDEX.md` for the execution order
...
Update `comms/outbox/versions/execution/v012/STATUS.md` after each feature:
