...
1. Read `comms/inbox/versions/execution/v002/THEME_INDEX.md` for the execution order
...
Update `comms/outbox/versions/execution/v002/STATUS.md` after each feature:
