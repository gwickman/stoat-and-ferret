...
- **State Management**: 13 Zustand stores including renderStore, previewStore, theaterStore, timelineStore, transitionStore
...
- [c4-code-gui-stores.md](./c4-code-gui-stores.md) -- 13 Zustand stores: activityStore, clipStore, composeStore, effectCatalogStore, effectFormStore, effectPreviewStore, effectStackStore, libraryStore, previewStore, projectStore, renderStore, theaterStore, timelineStore, transitionStore
...
C4Component
    ...
    Container_Boundary(gui, "Web GUI") {
        ...
        Component(stores, "State Stores", "TypeScript/Zustand", "13 stores: render, preview, theater, timeline, clip, compose, transition, effect*, library, project, activity")
