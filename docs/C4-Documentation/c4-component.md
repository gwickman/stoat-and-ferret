...
| Effects Engine | Effect definition registry with 41 built-in effects, JSON Schema validation, AI hints, and filter preview/build functions | 2 files | [c4-component-effects-engine.md](./c4-component-effects-engine.md) |
...
C4Component
    ...
    Container_Boundary(system, "stoat-and-ferret Video Editor") {
        ...
        Component(effects, "Effects Engine", "Python", "41 built-in effects, JSON Schema validation, AI hints, filter preview/build")
