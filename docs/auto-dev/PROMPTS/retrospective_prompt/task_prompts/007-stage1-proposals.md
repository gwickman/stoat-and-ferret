...
- **006 (handoff)**: Unactioned suggestions from handoff-to-next.md documents — promote any deferred work items or known limitations to product requests if not already tracked
