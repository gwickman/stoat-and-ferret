...
|---------|---------|-------|
| v075 | 0 + T | Keyframe compiler, markers/regions, test scaffolding |
| v076 | 1 + T | QC/compliance pass, delivery profiles, QC-as-test layer |
| v077 | 2 + T | Mastering chain + automation curves |
| v078 | 3 + T | Immersive sound design + tone synthesis |
| v079 | 4 + T | Reverse, split/razor, range-gating, time-remap |
| v080 | 5 + T | Video FX + keyframed visuals |
