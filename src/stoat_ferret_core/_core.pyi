...
class Automation:
    ...
    """
    @property
    def default(self) -> builtins.float:
        r"""
        Default value returned when no keyframes are present.
        """
    @property
    def keyframes(self) -> builtins.list[Keyframe]:
        r"""
...
class BatchProgress:
    ...
    """
    @property
    def total_jobs(self) -> builtins.int:
        r"""
        Total number of jobs in the batch.
        """
    @property
    def completed_jobs(self) -> builtins.int:
        r"""
        Number of jobs that completed successfully.
        """
    @property
    def failed_jobs(self) -> builtins.int:
        r"""
        Number of jobs that failed.
        """
    @property
    def overall_progress(self) -> builtins.float:
        r"""
...
class Clip:
    ...
    def source_path(self) -> builtins.str:
        ...
        """
    @property
    def clip_type(self) -> builtins.str:
        r"""
        Clip type: "file" or "generator".
        """
    @property
    def generator_params(self) -> typing.Optional[builtins.str]:
        r"""
...
class ClipWithEffects:
    ...
    """
    @property
    def input_index(self) -> builtins.int:
        r"""
        Zero-based FFmpeg input index (corresponds to the `-i` argument position).
        """
    @property
    def duration_secs(self) -> builtins.float:
        r"""
        Clip duration in seconds (must be > 0).
        """
    @property
    def framerate(self) -> builtins.float:
        r"""
...
class CompositionClip:
    ...
    def input_index(self) -> builtins.int:
        ...
        """
    @property
    def timeline_start(self) -> builtins.float:
        r"""
        Start time on the composition timeline in seconds.
        """
    @property
    def timeline_end(self) -> builtins.float:
        r"""
        End time on the composition timeline in seconds.
        """
    @property
    def track_index(self) -> builtins.int:
        r"""
        Track index for multi-track layouts.
        """
    @property
    def z_index(self) -> builtins.int:
        r"""
...
class ConcatCommand:
    ...
    """
    @property
    def concat_file_content(self) -> builtins.str:
        r"""
...
class FfmpegProgressUpdate:
    ...
    """
    @property
    def frame(self) -> typing.Optional[builtins.int]:
        r"""
    ...
    def fps(self) -> typing.Optional[builtins.float]:
        ...
        """
    @property
    def out_time_us(self) -> builtins.int:
        r"""
        Output time in microseconds (primary progress metric).
        """
    @property
    def bitrate(self) -> builtins.str:
        r"""
    ...
    def speed(self) -> builtins.str:
        ...
        """
    @property
    def progress_end(self) -> builtins.bool:
        r"""
...
class LoudnessReport:
    ...
    """
    @property
    def integrated_lufs(self) -> builtins.float:
        r"""
        Integrated loudness in LUFS.
        """
    @property
    def lra(self) -> builtins.float:
        r"""
        Loudness range in LU.
        """
    @property
    def true_peak_dbtp(self) -> builtins.float:
        r"""
        True peak in dBTP.
        """
...
class PeakReport:
    ...
    """
    @property
    def peak_level(self) -> builtins.float:
        r"""
        Peak level in dB.
        """
    @property
    def clipped_samples(self) -> builtins.int:
        r"""
...
class ProgressInfo:
    ...
    def progress(self) -> builtins.float:
        ...
        """
    @property
    def eta_seconds(self) -> typing.Optional[builtins.float]:
        r"""
        Estimated seconds remaining, or None if progress is zero.
        """
    @property
    def frames_done(self) -> typing.Optional[builtins.int]:
        r"""
        Frames encoded so far (None if unknown).
        """
    @property
    def total_frames(self) -> typing.Optional[builtins.int]:
        r"""
...
class RenderSegment:
    ...
    def frame_count(self) -> builtins.int:
        ...
        """
    @property
    def cost_estimate(self) -> builtins.float:
        r"""
...
class RenderSettings:
    ...
    def codec(self) -> builtins.str:
        ...
        """
    @property
    def quality_preset(self) -> builtins.str:
        r"""
    ...
    def fps(self) -> builtins.float:
        ...
        """
    @property
    def audio_sample_rate(self) -> typing.Optional[builtins.int]:
        r"""
        Audio sample rate in Hz (e.g., 44100, 48000, 96000). None = not set.
        """
    @property
    def audio_bit_depth(self) -> typing.Optional[builtins.int]:
        r"""
...
class RenderTransition:
    ...
    """
    @property
    def transition_type(self) -> builtins.str:
        r"""
        FFmpeg xfade transition type (e.g. "fade", "wipeleft").
        """
    @transition_type.setter
    def transition_type(self, value: builtins.str) -> None:
        r"""
        FFmpeg xfade transition type (e.g. "fade", "wipeleft").
        """
    @property
    ...
    def duration_secs(self, value: builtins.float) -> None:
        r"""
        Transition duration in seconds (must be > 0).
        """
...
class SpectralReport:
    ...
    def channel_count(self) -> builtins.int:
        ...
        """
    @property
    def channel_means(self) -> builtins.list[builtins.float]:
        r"""
...
class SpeedSegment:
    ...
    """
    @property
    def start_frame(self) -> builtins.int: ...
    @property
    def end_frame(self) -> builtins.int: ...
    @property
    def speed_factor(self) -> builtins.float: ...
...
class TrackAudioConfig:
    ...
    * `fade_out` - Fade-out duration in seconds (0.0 = no fade)
    ...
    def volume(self) -> builtins.float:
        ...
        """
    @property
    def fade_in(self) -> builtins.float:
        r"""
        Fade-in duration in seconds (0.0 = no fade).
        """
    @property
    def fade_out(self) -> builtins.float:
        r"""
...
class VersionInfo:
    ...
    """
    @property
    def core_version(self) -> builtins.str:
        r"""
        Semver version from Cargo.toml (`CARGO_PKG_VERSION`).
        """
    @property
    def build_timestamp(self) -> builtins.str:
        r"""
...
def compile_automation(automation: Automation) -> builtins.str:
    r"""
...
def ducking_effect_schema() -> builtins.list[ParameterSchema]:
    r"""
...
def parameter_schemas_from_dict(schema: dict, ai_hints: dict) -> builtins.list[ParameterSchema]:
    r"""
...
def parse_loudness_report(output: builtins.str) -> LoudnessReport:
    r"""
...
def parse_peak_report(output: builtins.str) -> PeakReport:
    r"""
...
def parse_silence_report(output: builtins.str) -> SilenceReport:
    r"""
...
def parse_spectral_report(output: builtins.str) -> SpectralReport:
    r"""
...
def parse_video_defect_report(output: builtins.str) -> VideoDefectReport:
    r"""
