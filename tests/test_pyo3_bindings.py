...
class TestTimelineTypes:
    ...
    def test_position_to_seconds(self) -> None:
        ...
        fps = FrameRate.fps_24()
        pos = Position(48)
        assert pos.as_secs(fps) == pytest.approx(2.0, abs=1e-9)
...
class TestCompositionTimeline:
    ...
    def test_composition_clip_duration(self) -> None:
        ...
        assert clip.duration() == pytest.approx(5.0, abs=1e-9)
    ...
    def test_calculate_composition_positions(self) -> None:
        ...
        assert adjusted[1].timeline_start == pytest.approx(4.0, abs=1e-9)  # Shifted left by 1.0s
    ...
    def test_calculate_timeline_duration(self) -> None:
        ...
        assert duration == pytest.approx(9.0, abs=1e-9)
